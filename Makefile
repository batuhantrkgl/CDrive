...
LIBS_windows = -lcurl -ljson-c -lws2_32 -lshell32 -lm -lpthread
LIBS_linux = -lcurl -ljson-c -lm -lpthread
LIBS_darwin = /opt/osxcross/target/lib/libcurl.a /opt/osxcross/target/lib/libjson-c.a -lz -framework CoreFoundation -framework CoreServices -framework SystemConfiguration -lm -lpthread
